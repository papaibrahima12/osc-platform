...
export default function CreateManager() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const createToast = toast.loading('Création du gestionnaire en cours...');
        ...
        try {
            ...
            toast.success('Gestionnaire créé avec succès. Un email avec les identifiants a été envoyé.', {
                id: createToast,
                duration: 5000
            });
            ...
            const errorMessage = err instanceof Error && err.message === 'Un utilisateur avec cet email existe déjà'
                ...
                : err instanceof Error ? err.message : 'Une erreur est survenue lors de la création du gestionnaire';
    ...
    return (
        <div className="space-y-6">
            <div className="mt-5">
                <h1 className="text-2xl font-bold text-gray-900">Nouveau Gestionnaire</h1>
                <p className="text-gray-500 mt-1">Créer un nouveau compte gestionnaire</p>
            </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="bg-blue-50 rounded-lg p-4 border border-blue-100">
                            ...
                            <p className="mt-1 text-sm text-blue-700">
                                Un email contenant les identifiants de connexion sera envoyé au gestionnaire.
                            </p>
                        </div>
                        ...
                        <div className="flex justify-end space-x-3">
                            ...
                            >
                                {isLoading ? 'Création...' : 'Créer Gestionnaire'}
                            </button>
                        </div>
                    </form>
                </div>
