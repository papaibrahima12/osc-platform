...
export default function Navbar() {
  ...
  return (
      <div className="h-24 bg-white border-b border-gray-200 fixed top-0 right-0 left-64 z-50 shadow-md">
        <div className="h-full px-4 flex items-center justify-between">
          {/* Icône centrale avec le texte */}
          <div className="flex-1 flex flex-col items-center justify-center">
            ...
            <p className="text-black text-sm font-semibold italic text-center">
